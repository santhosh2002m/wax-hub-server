...
module.exports = {
    up: async (queryInterface) => {
        ...
        // Get special counter
        const [specialCounter] = (await queryInterface.sequelize.query("SELECT id FROM counters WHERE username = 'special_counter';"));
...
//# sourceMappingURL=006-special-ticket-seeder.js.map