...
module.exports = {
    up: async (queryInterface, Sequelize) => {
        ...
        if (tableDescription.category) {
            ...
            console.log("Column category does not exist in tickets table, skipping removal");
        }
    },
    down: async (queryInterface, Sequelize) => {
        ...
        if (!tableDescription.category) {
            ...
            console.log("Column category already exists in tickets table, skipping addition");
        }
    },
};
//# sourceMappingURL=20250101-remove-category-from-tickets.js.map