...
module.exports = {
    up: async (queryInterface, Sequelize) => {
        ...
        if (tableDescription.dropdown_name && !tableDescription.ticket_type) {
            await queryInterface.renameColumn("Tickets", "dropdown_name", "ticket_type");
            console.log("Column dropdown_name renamed to ticket_type");
        }
        else {
            console.log("Column dropdown_name not found or ticket_type already exists, skipping rename");
        }
    ...
    down: async (queryInterface, Sequelize) => {
        ...
        if (tableDescription.ticket_type) {
            await queryInterface.renameColumn("Tickets", "ticket_type", "dropdown_name");
...
//# sourceMappingURL=20240827-alter-ticket.js.map